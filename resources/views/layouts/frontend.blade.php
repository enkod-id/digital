                        ...
                        <ul class="mini-cart__list">
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-image">
                                    <img src="{{asset('fe')}}/assets/img/products/product-11-90x90.jpg" alt="products">
                                </div>
                            ...
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-image">
                                    <img src="{{asset('fe')}}/assets/img/products/product-12-90x90.jpg" alt="products">
                                </div>
                                <div class="mini-cart__product-content">
                                    <a class="mini-cart__product-title" href="product-details.html">Lexbaro Begadi</a>
                                    <span class="mini-cart__product-quantity">1 x $49.00</span>
                            ...
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-image">
                                    <img src="{{asset('fe')}}/assets/img/products/product-13-90x90.jpg" alt="products">
                                </div>
                                <div class="mini-cart__product-content">
                                    <a class="mini-cart__product-title" href="product-details.html">Lexbaro Begadi</a>
                                    <span class="mini-cart__product-quantity">1 x $49.00</span>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="item">
                                    <figure class="product-gallery__image">
                                        <img src="{{asset('fe')}}/assets/img/products/product-03-270x300.jpg" alt="Product">
                                        <span class="product-badge sale">Sale</span>
                                    </figure>
                                </div>
                                <div class="item">
                                    <figure class="product-gallery__image">
                                        <img src="{{asset('fe')}}/assets/img/products/product-04-270x300.jpg" alt="Product">
                                        <span class="product-badge sale">Sale</span>
                                    </figure>
                                </div>
                                <div class="item">
                                    <figure class="product-gallery__image">
                                        <img src="{{asset('fe')}}/assets/img/products/product-05-270x300.jpg" alt="Product">
                                        <span class="product-badge sale">Sale</span>
                                    </figure>
                                </div>
                                <div class="item">
                                    <figure class="product-gallery__image">
                                        <img src="{{asset('fe')}}/assets/img/products/product-06-270x300.jpg" alt="Product">
                                        <span class="product-badge sale">Sale</span>
                                    </figure>
                                </div>
                                </div>
