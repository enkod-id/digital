    ...
    <div class="element-carousel slick-right-bottom" data-slick-options='{
        ...
        <div class="item">
            <div class="single-slide d-flex align-items-center bg-image"
                data-bg-image="{{asset('fe')}}/assets/img/slider/slider-bg-01.jpg">
                <div class="container">
                    <div class="row align-items-center no-gutters w-100">
                        ...
                        <div class="col-lg-4 offset-lg-2 col-md-4">
                            <figure class="slider-image d-none d-md-block">
                                <img src="{{asset('fe')}}/assets/img/slider/slider-image-01.png" alt="Slider Image">
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-slide d-flex align-items-center bg-image"
                ...
                <div class="container">
                    <div class="row align-items-center no-gutters w-100">
                        ...
                        <div class="col-lg-4 offset-lg-2 col-md-4">
                            <figure class="slider-image d-none d-md-block">
                                <img src="{{asset('fe')}}/assets/img/slider/slider-image-02.png" alt="Slider Image">
                            </figure>
                        </div>
                    </div>
                </div>
