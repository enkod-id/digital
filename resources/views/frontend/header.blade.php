                    ...
                    <div class="header__col header__left">
                        <a href="index.html" class="logo">
                            <figure class="logo--normal">
                                <img src="{{asset('fe')}}/assets/img/logo/logo.png" alt="Logo">
                            </figure>
                    ...
                    <div class="header__col header__center">
                        <nav class="main-navigation d-none d-lg-block">
                            <ul class="mainmenu">
                                ...
                                <li class="mainmenu__item">
                                    <a href="" class="mainmenu__link">Menu</a>
                                </li>
                                <li class="mainmenu__item">
                                    <a href="" class="mainmenu__link">Blog</a>
                                </li>
                                <li class="mainmenu__item">
                                    <a href="" class="mainmenu__link">Gallery</a>
                                </li>
                                <li class="mainmenu__item">
                                    <a href="" class="mainmenu__link">Contact Us</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
